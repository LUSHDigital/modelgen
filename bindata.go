...
func tmplModelHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "tmpl/model.html", size: 4767, mode: os.FileMode(420), modTime: time.Unix(1513872191, 0)}
